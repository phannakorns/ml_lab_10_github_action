...
def transition_model_alias(model_name, alias):
    ...
    try:
        ...
        # Use transition_model_version_stage for older MLflow versions
        print(f"Transitioning model version {version_number} to stage '{alias}'...")
        client.transition_model_version_stage(
            name=model_name,
            version=version_number,
            stage=alias,
        )
        print(f"Successfully transitioned model '{model_name}' version {version_number} to stage '{alias}'.")
